...
> You can also access the MySql server using any database management software, e.g [TablePlus](https://tableplus.com/) with the host set to `localhost` and port `3306`.
